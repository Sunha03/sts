...
<body>
	<h1>WAS에서 제공하는 Connection Pool 이용</h1>
	<hr/>
	<h2>WAS마다 각각의 고유한 자원으로 Connection Pool을 만들고 관리함
		...
		2. WAS에서 lookup한 DataSoure로부터 커넥션을 가져옴
			- DriverManager와 동일하게 getConnection 이용</h2>
	
	<%
		//1. WAS에 등록된 자원을 찾아올 수 있는 기능을 제공하는 객체 생성
